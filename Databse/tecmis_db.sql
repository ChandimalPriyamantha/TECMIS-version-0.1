...
-- Schema tecmis_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `tecmis_db` DEFAULT CHARACTER SET utf8mb3 ;
USE `tecmis_db` ;
...
CREATE TABLE IF NOT EXISTS `tecmis_db`.`attendence` (
  ...
  PRIMARY KEY (`attendence_id`, `student_id`),
  INDEX `fk_attendence_student1_idx` (`student_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `tecmis_db`.`gpa` (
  ...
  `GPA_Value` INT NULL DEFAULT NULL,
  PRIMARY KEY (`ID`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb3;
...
CREATE TABLE IF NOT EXISTS `tecmis_db`.`lecture_matireal` (
  `lecture_matireal_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tecmis_db`.`mark` (
  ...
  `level` VARCHAR(45) NULL DEFAULT NULL,
  `assesment` INT NULL DEFAULT NULL,
  ...
  `mid_term` INT NULL DEFAULT NULL,
  `final_theory` INT NULL DEFAULT NULL,
  `final_practicle` INT NULL DEFAULT NULL,
  `student_id` VARCHAR(20) NOT NULL,
